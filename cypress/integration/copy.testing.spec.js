...
describe("Prueba Monkey sobre Ghost App", function () {
  ...
  it("Crear post", function () {
    ...
    singlePostPage.getFirstPublishButton().click();
    singlePostPage.getSecondPublishButton().click();
    singlePostPage.getThirdPublishButton().click();
    ...
    //   cy.wrap(title).type("Monkey Testing Post ", { force: true });
    // });
